                ...
                <div class="col-lg-7">
                    ...
                    <div class="d-flex flex-column flex-md-row mt-4 pt-1">
                        <?php if ($links[0]['link_label']):?>
                            <div><a class="<?php echo $btn_class?>" href="<?php echo $links[0]['link'] ?>"><?php echo $links[0]['link_label'] ?></a></div>
                        <?php endif ?>
                        <?php if ($links[1]['link_label']):?>
                            <div><a class="<?php echo $btn_class?>" href="<?php echo $links[1]['link'] ?>"><?php echo $links[1]['link_label'] ?></a></div>
                        <?php endif ?>
                        <?php if ($links[2]['link_label']):?>
                            <div><a class="<?php echo $btn_class?>" href="<?php echo $links[2]['link'] ?>"><?php echo $links[2]['link_label'] ?></a></div>
                        <?php endif ?>
                    </div>
                </div>
