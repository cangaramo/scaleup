...
<div class="bg-gray">
    <div class="container pt-5 pb-4" id="grid">
        ...
        <div class="box-200 bg-image" style="background-image:url('<?php echo $group1['image']?>')">
            ...
            <div class="p-4 py-5 p-lg-5 position-relative">
        ...
        <div class="row pt-3">
            ...
            <div class="col-md-6 pr-md-2 mb-3"> 
                <?php foreach ($links as $link): ?>
                    ...
                    <div class="link-box px-4 px-lg-5" onClick="redirectTo('<?php echo $link['link'] ?>')"
            ...
            <div class="col-md-6 pl-md-2">
                <div class="box-400 p-3 p-lg-5" style="background-image:url('<?php echo $group2['image']?>')">
